...
# time python3 cnn_main.py --select_dir 'GCRR' --net resnet50 --patience 3
# time python3 cnn_main.py --select_dir 'GCRR' --net resnet152 --patience 3
...
time python3 image_regression.py --select_dir 'GCRR'
