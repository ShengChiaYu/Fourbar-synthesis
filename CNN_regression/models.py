...
class LeNet(nn.Module):
    def __init__(self, args):
        ...
        if args.select_dir is not None:
            self.conv3 = nn.Conv2d(50, 5, 4, 1)
        else:
            self.conv3 = nn.Conv2d(50, self.args.class_num, 4, 1)
    ...
    def forward(self, x):
        ...
        # print(out.shape)
        # print(out)
        if self.args.select_dir is not None:
            out = out.view(-1,5)
        else:
            out = out.view(-1,self.args.class_num)
        # print(out)
...
def resnet50(args, pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, args,
                   **kwargs)
...
def resnet152(args, pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress, args,
                   **kwargs)
